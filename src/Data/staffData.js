export const staffData = [
    ...
    submenu: [
      {
        ...
        email: "maguilera@sccdac.org",
        img: "./images/staff_images/marcandrew.jpg",
        bio: "",
        showBio: false,
      },
      {
        ...
        email: "tandersonsmith@sccdac.org",
        img: "./images/staff_images/tomika.jpg",
        bio: "Tomika Anderson-Smith has spent her career building operational infrastructure across mission-driven organizations and the tech industry. She previously served as Director of Operations at Equal Rights Advocates, a national civil rights organization, and as Senior Manager at Internet Archive, where she ran operations for the digital library that hosts the Wayback Machine. She is a two-time AmeriCorps alum and has worked with a variety of nonprofits including: Playworks, Architecture for Humanity, Nonprofit Leadership Alliance, Mid-America Regional Council, and a county Boys Group Home. Most recently, she brought her operational expertise to tech and venture capital, helping early-stage companies establish a strong operational foundation. Throughout her career, Tomika has been drawn to organizations that combine ambitious vision with tangible impact. She serves on the board of Youth Volunteer Corps and joined DAC motivated by a deep belief that vulnerable populations deserve operational excellence and leaders who understand that good systems aren't just about efficiency—they're about dignity.She holds a BS with honors from William Jewell College, a master's in public administration from the University of Missouri-Kansas City, a graduate certificate in nonprofit management from Rockhurst University, and is a Certified Nonprofit Professional (CNP). Tomika lives in San Francisco with her husband, two young daughters, and rescue pup.",
        showBio: false,
      },
      {
        staff_office: "Executive Team",
  ...
  },
  {
    ...
    submenu: [
      ...
      // },
      {
        ...
        last_name: "Brauer",
        suffix_name: "",
        title: "Supervising Attorney ODC",
      ...
      },
      {
        ...
        staff_id: 45,
        first_name: "Yolanda",
        last_name: "Castro-Lopez",
        suffix_name: "",
        title: "Operations Coordinator",
        email: "ycastrolopez@sccdac.org",
      ...
      },       
      {
        ...
        last_name: "Johnson",
        suffix_name: "M.S.W",
        title: "Social Work Program Director",
  ...
  },
  {
    ...
    submenu: [
      ...
      // },
        ...
        staff_id: 45,
        first_name: "Julissa",
        last_name: "Churape-Lopez",
        suffix_name: "",
        title: "Administrative Assistant",
        email: "jchurape@sccdac.org",
        img: "./images/staff_images/default.png",
        bio: "",
        showBio: false,
      },
      {
        ...
        last_name: "Tran",
        suffix_name: "",
        title: "Case Coordinator / DAC Notary",
    ...
    submenu: [
      {
        ...
        last_name: "Brauer",
        suffix_name: "",
        title: "ODC Supervising Attorney",
        email: "sbrauer@sccdac.org",
        img: "./images/staff_images/brauer.jpg",
        bio: "",
        showBio: false,
  ...
  },
  {
    ...
    submenu: [
      ...
      //   suffix_name: "J.D.",
      //   title: "Staff Attorney",
      //   email: "mlucas@sccdac.org",
      //   img: "./images/staff_images/Megan.jpg",
      //   bio: "Megan recently joined DAC in 2025 after spending several years practicing as a children's attorney in Washington D.C.  In law school at the University of Minnesota, Megan concentrated on public interest law, working at the Office of the Hennepin County Attorney in Minneapolis and representing survivors of family violence with the assistance of a clerkship from the Minnesota Justice Foundation.  Megan has since worked with families entangled in the family regulation system in both managerial and legal capacities.  She also worked at the Office of the San Francisco Public Defender and has demonstrated an unwavering commitment to client-centered representation and zealous advocacy.",
      //   showBio: false,
      // },
            {
        staff_office: "Family Legal Advocates",
      ...
      },
      {
        ...
        suffix_name: "J.D.",
        title: "Staff Attorney",
        email: "snasir@sccdac.org",
        img: "./images/staff_images/SashaN.jpg",
        bio: "",
        showBio: false,
      },
            {
  ...
  },
  {
    ...
    submenu: [
      ...
      // },
      {
        ...
        suffix_name: "J.D.",
        title: "Staff Attorney",
        email: "oalvarado@sccdac.org",
        img: "./images/staff_images/Otmar.png",
        bio: "Otmar joined the team in 2025 after graduating from Golden Gate University School of Law and passing the California Bar. Prior to joining DAC, he gained experience in civil litigation, family law, and real estate, where he developed a deep commitment to serving clients facing instability and systemic inequity. He is inspired by DAC’s mission to preserve family unity and fight for dignity in the face of state intervention. Outside of work, Otmar enjoys writing fiction, exploring California’s history and spending time with his family.",
        showBio: false,
      },
            {
        staff_office: "Dependency Legal Associates",
        ...
        suffix_name: "",
        title: "Staff Attorney",
        email: "kdesai@sccdac.org",
        img: "./images/staff_images/krishnad.jpg",
        bio: "",
        showBio: false,
      },
    ...
    submenu: [
      {
        ...
        img: "./images/staff_images/MaggieC.jpg",
        bio: "",
        showBio: false,
      },
      {
  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        phone: "",
        img: "./images/staff_images/melissae.jpg",
      ...
      },
      {
        ...
        suffix_name: "",
        title: "Mentor Parent",
        email: "jnunez@sccdac.org",
        phone: "",
        img: "./images/staff_images/joseph.jpg",
        bio: "",
        showBio: false,
      },
      {
        ...
        phone: "",
        img: "./images/staff_images/rehmir.jpg",
  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        suffix_name: "",
        title: "Staff Attorney",
        email: "ajohnson@sccdac.org",
        img: "./images/staff_images/andrew.jpg",
        bio: "",
        showBio: false,
      },
      // {
      ...
      },
      {
        ...
        img: "./images/staff_images/Kim.jpg",
  ...
  //       last_name: "Castro-Lopez",
  //       suffix_name: "",
  //       title: "Outreach & Referrals Coordinator",
  //       email: "ycastrolopez@sccdac.org",
  //       img: "./images/staff_images/default.png",
  //       bio: "",
  //       showBio: false,
  ...
  //       img: "./images/staff_images/Kristi2.jpg",
