...
export default function Donate() {
  const openDonate = () => {
    const fru = window.FundraiseUp;
    if (!fru || typeof fru.openCheckout !== "function") return;

    // Defer out of React’s synthetic event to avoid the dev overlay
    setTimeout(() => {
      try {
        fru.openCheckout("FUNLHWCJLCM", {
          donation: {
            currency: "USD",
            // amount: 25,           // OPTIONAL preset
            // recurring: "once",    // or "monthly"
          },
          // supporter: { email: "", firstName: "", lastName: "" }, // OPTIONAL
          // designations: [{ id: "EXXXXXXX" }],                    // OPTIONAL
          // config: { modifyAmount: true }                         // OPTIONAL UI behavior
        });
      } catch (e) {
        console.error("Fundraise Up threw:", e);
      }
    }, 0);
  };
    ...
    <section id="donate" className="section single-page-layout donate-section">
      ...
      <div className="donate-content programs-intro position-center">
        <div className="donate-copy-container">
          <h1 className="donate-header text-center">
          ...
          <div className="donate-img-container donate-img-container-mobile">
            ...
            <p className="donate-quote">
              <BiSolidQuoteLeft className="donate-quote-left" />
              My team (attorney, social worker and mentor parent) really understands me. They get me, they help me, and they want to see me succeed.
              <BiSolidQuoteRight className="donate-quote-right" />
            </p>
          </div>

          {/* Fundraise Up donate button */}
          <button type="button" className="donate-btn position-center" onClick={openDonate}>
            Donate Now
          </button>
        ...
        <div className="donate-img-container">
          ...
          <p className="donate-quote">
            <BiSolidQuoteLeft className="donate-quote-left" />
            My team (attorney, [DAC] social worker and mentor parent) really understands me. They get me, they help me, and they want to see me succeed.
            <BiSolidQuoteRight className="donate-quote-right" />
          </p>
        </div>
      </div>
